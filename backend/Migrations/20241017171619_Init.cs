        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryCarePhysicianId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    IdentificationDocumentURL = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    DisclosureOfHealthInfo = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.UserId);
                    table.CheckConstraint("CK_Emergency_Phone", "EmergencyPhoneNumber LIKE '+%'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Expected_Appointment_Date", "ExpectedAppointmentDate > GETDATE()");
                    table.CheckConstraint("CK_Status_Reason", "(Status = 'Cancelled' AND ReasonForCancellation IS NOT NULL) OR (Status != 'Cancelled' AND ReasonForCancellation IS NULL)");
                    table.ForeignKey(
